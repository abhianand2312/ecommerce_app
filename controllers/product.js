    ...
    form.parse(req, (err, fields, files) => {
        ...
        if(files.photo) {
            ...
            if(files.photo.size > 1000000 ) {
                return res.status(400).json({
                    error: "Image's size should be less than 1 mb"
                });
            }
 ...
 * if no params are sent, return all product
 */
...
/**
 * we will find the related products based upon the 
 * category except that product
 */
